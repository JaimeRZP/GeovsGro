...
def compute_posterior(information_instances):
    ...
    #ZP: want to print out the posterior distributions. 
    output_histograms = []
    ...
    for index, name in enumerate(plotted_parameters):
        ...
        for info in information_instances:
            if not info.ignore_param:
                ...
                output_histograms.append(name)
                output_histograms.append(info.interp_hist)
		output_histograms.append(info.interp_grid)
    ...
    #ZP: Output histograms as well 
    output_hist = open("Output_histograms", "w")
    print >> output_hist,  output_histograms
