...
class Data(object):
    ...
    def __init__(self, command_line, path):
        ...
        * :attr:`log_flag`
        ...
        #ZP: We want to store the theory prediction if and only 
        #if its originating point gets accepted in the MCMC chain.
        #These attributes simply keep track of the quantities at all times  
        self.xi_theory1 = []
        self.xi_theory2 = []
        self.omega_m1 = []
        self.omega_m2 = [] 
        self.sigma_8_1 = []
        self.sigma_8_2 = []
        #ZP: MCMC.py sets storage to True if the point gets accepted 
        #telling a function to store the previous attributes in the ones below 
        self.xi_theory1_storage = []
        self.xi_theory2_storage = []
        self.param1_storage = []
        self.param2_storage = []
        """
        ...
        :rtype:   dict
        """
        self.mcmc_parameters = od() #ZP: But still only one mcmc directory 
        """
        ...
        self.need_cosmo2_update = True  #ZP: Second set of parameters update
        """
    ...
    def group_parameters_in_blocks(self):
        ...
        #ZP: Even though there's only one ordered-dictionary of mcmc parameters get_mcmc_parameters gets called 
	# upon both sets of parameters 
    ...
    def update_cosmo1_arguments(self):
        ...
        for elem in self.get_mcmc_parameters(['cosmo1']):
            ...
            '''
	#ZP: Here we have the updating function of the second set of parameters
